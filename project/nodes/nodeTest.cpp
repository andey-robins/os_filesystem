...
int main() 
{
	...
	cout << endl << "First we will run tests on the file iNode functions..." << endl;
	...
	*/	
	...
	cout << endl << "Here is the directory iNode created by createDirNode('A', 5, 'F'): " << endl;
	printNode(myDNode);
	//NOTE: This test seems to pass as expected.
	...
	*/	
	...
	cout << endl << "Here is the indirect iNode created by createIndirNode(): " << endl;
	printNode(myINode);
	//NOTE: This test seems to pass as expected.
